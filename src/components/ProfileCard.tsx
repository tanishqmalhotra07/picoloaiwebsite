        ...
        <div className="pc-inside">
          ...
          <div className="pc-content">
            <div className="pc-details">
              <h3 className="text-[7px] sm:text-xl md:text-2xl font-bold text-white text-center leading-tight h-[3.5rem] sm:h-[6rem] flex items-center justify-center line-clamp-3 px-2">{name || title}</h3>
              {image && (
