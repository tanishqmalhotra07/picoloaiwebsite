        ...
        <div className="pc-inside">
          ...
          <div className="pc-content">
            <div className="pc-details">
              <h3 className="text-sm sm:text-xl md:text-3xl font-bold text-white text-center leading-tight h-[4rem] sm:h-[4.5rem] flex items-center justify-center line-clamp-3">{name || title}</h3>
              {image && (
